...
console.log(encabezado.innerText); // Si en CSS visibility esta en hidden no trae el texto
console.log(encabezado.textContent); // Este lo trae en todos los casos
